...
import { Bookmarks } from '../../screens/student/Bookmarks';
import { CourseDetail } from '../../screens/student/CourseDetail';
import { CourseList } from '../../screens/student/CourseList';
import { LessonPlayer } from '../../screens/student/LessonPlayer';
import { MessageDetail } from '../../screens/common/MessageDetail';
...
import { RateCourse } from '../../screens/student/RateCourse';
import { SearchAdvanced } from '../../screens/student/SearchAdvanced';
import { StudentCourseReviews } from '../../screens/student/StudentCourseReviews';
import { StudentHome } from '../../screens/student/StudentHome';
import { HelpCenterNew } from '../../screens/common/HelpCenterNew';
import { SupportRequest } from '../../screens/common/SupportRequest';
import { SupportRequestSuccess } from '../../screens/common/SupportRequestSuccess';
...
export const studentRoutes: AppRouteDefinition[] = [
  ...
  { path: '/notifications', element: <Notifications />, requiresAuth: true, allowedRoles: allAuthenticatedRoles },
  ...
  { path: '/help', element: <HelpCenterNew />, requiresAuth: true, allowedRoles: allAuthenticatedRoles },
  { path: '/help/support-request', element: <SupportRequest />, requiresAuth: true, allowedRoles: allAuthenticatedRoles },
  { path: '/help/support-success', element: <SupportRequestSuccess />, requiresAuth: true, allowedRoles: allAuthenticatedRoles },
  { path: '/report-violation', element: <StudentReportViolation />, requiresAuth: true, allowedRoles: allAuthenticatedRoles },
  { path: '/report-success', element: <ReportSuccessGeneral />, requiresAuth: true, allowedRoles: allAuthenticatedRoles },
  { path: '/my-reports', element: <MyReports />, requiresAuth: true, allowedRoles: allAuthenticatedRoles },
  { path: '/my-reports/:id', element: <MyReportDetail />, requiresAuth: true, allowedRoles: allAuthenticatedRoles },
